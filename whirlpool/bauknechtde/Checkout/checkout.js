...
$(document).ready(function () {
    if (
        ...
        waitForEl(".totalizers-list", function () {
            const textToAppend = `<div class="vat-label-container"><span class="vat-label-text">Inkl. MwSt.</span></div>`;
...
function changeNewsletterChk() {
    if (
        ...
        $(".newsletter").html(
            '<label class="checkbox newsletter-label" data-bind="fadeVisible: checkout.canEditData"><input type="checkbox" id="opt-in-newsletter" data-bind="checked: checkout.optinNewsLetter, enable: checkout.saveData"><span class="newsletter-text" data-i18n="global.optinNewsLetter">Ich willige in die Verarbeitung meiner personenbezogenen Daten ein, um Bauknecht Hausgeräte GmbH die Möglichkeit zu geben, mir Newsletter/Marketingmitteilungen (in elektronischer und nichtelektronischer Form), einschließlich per Telefon, Post, E-Mail, Messenger Diensten, Push-Benachrichtigungen oder Banner auf Websites Dritter, einschließlich auf Meta- und Google-Plattformen in Irland und den USA für Direktmarketing über Produkte und Dienstleistungen von Bauknecht Hausgeräte GmbH, die ich sogar gekauft oder registriert habe, zuzusenden, sowie um Marktforschung zu betreiben. Ihre Einwilligung in den Versand ist jederzeit widerruflich.</span></label>'
        );
    } else {
        $(".newsletter").html(
...
//--------------------------------------------
//-----ADD PRIVACY POLICY NEW BOX-------------
//--------------------------------------------
$(document).ready(function () {
    $(".box-client-info").append('<div><p class="privacy-policy-box"><strong>Information zum Widerspruch bei Information über verwandte Produkte (für den Online Shop)</strong> <br> <br>Wir nutzen Ihre E-Mail-Adresse und Ihre Telefonnummer neben der Vertragsabwicklung, um Sie per E-Mail /Messenger Diensten über ähnliche Waren/Dienstleistungen zu informieren. Dieser Verarbeitung Ihrer personenbezogenen Daten zur Direktwerbung können Sie jederzeit widersprechen, ohne dass Ihnen dabei andere als die Übermittlungskosten nach den Basistarifen entstehen (z.B. per E-Mail an data_protection_emea@whirlpool.com oder durch Anklicken der Schaltfläche am Ende jeder Marketingmitteilung). Die Verarbeitung Ihrer Daten erfolgt entsprechend unserer <a href="/seiten/datenschutzerklaerung" class="link privacy-policy-link" target="_blanck">Datenschutzerklärung</a>.</p></div>');
});
  //--------------------------------------------
  //-----END PRIVACY POLICY NEW BOX-------------
  //--------------------------------------------
