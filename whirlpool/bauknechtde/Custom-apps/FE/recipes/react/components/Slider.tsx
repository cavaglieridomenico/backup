...
const Slider: StorefrontFunctionComponent<SliderProps> = ({
  ...
  description = description ? description : singleRecipe.description;
  subdescription = subdescription ? subdescription : singleRecipe.subdescription;
      ...
      <div className={styles.carouselTopTextDiv}>
        <div className={styles.carouselTopTextContainer}>
          ...
          <span className={styles.carouselTopTextTime}>
            ...
            <span className={styles.textNearIcon}>{singleRecipe.cooktime}</span>
          </span>
          <span className={styles.carouselTopTextPrep}>
            ...
            <span className={styles.textNearIcon}>
              {singleRecipe.preparationtime}
            </span>
          </span>
          <span className={styles.carouselTopTextLevel}>
            ...
            <span className={styles.textNearIcon}>{singleRecipe.level}</span>
          </span>
        </div>
      </div>
    </div>
