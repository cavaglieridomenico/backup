...
const CustomForm: StorefrontFunctionComponent<CustomFormProps> = ({}) => {
  ...
  const contactReason = [
    ...
    {
      value: "Richiesta informazioni sul prodotto",
      label: "Richiesta informazioni sul prodotto",
    },
    {
      value: "Informazioni per acquisto accessori e  prodotti per la pulizia",
      label: "Informazioni per acquisto accessori e  prodotti per la pulizia",
    },
    {
      value:
        "Informazioni Acquisto sullo shop online effettuato su www.hotpoint.it",
      label:
        "Informazioni Acquisto sullo shop online effettuato su www.hotpoint.it",
    },
    {
      value: "Richiesta assistenza tecnica su  prodotto da 0 a 24 mesi",
      label: "Richiesta assistenza tecnica su  prodotto da 0 a 24 mesi",
    },
    {
      value:
    ...
    {
      value: "Richiesta assistenza tecnica su  prodotto fuori garanzia",
      label: "Richiesta assistenza tecnica su  prodotto fuori garanzia",
    },
    {
      value: "Informazioni/segnalazioni su intervento in corso",
      label: "Informazioni/segnalazioni su intervento in corso",
    },
    {
      value: "Attivazione piano estensione di assistenza",
      label: "Attivazione piano estensione di assistenza",
    },
    {
      value: "Devo aggiornare i dati del mio appuntamento",
      label: "Devo aggiornare i dati del mio appuntamento",
    },
    {
      value: "Spostare o cancellare un appuntamento",
      label: "Spostare o cancellare un appuntamento",
    },
    { value: "Elettrodomestici connessi", label: "Elettrodomestici connessi" },
    {
      value:
  ...
  const submitForm = (e: any) => {
    ...
    if (handleValidation()) {
      ...
      if (
        ...
        fields["Reason"] ==
          "Informazioni/segnalazioni su intervento in corso" ||
        ...
        fields["Reason"] ==
        "Informazioni per acquisto accessori e  prodotti per la pulizia"
      ) {
        ...
        fields["Reason"] ==
        "Richiesta assistenza tecnica su  prodotto fuori garanzia"
      ) {
        formToSend["supportEmail"] = { value: "itservice199@whirlpool.com" };
      } else if (
        fields["Reason"] ==
          "Richiesta assistenza tecnica su  prodotto da 0 a 24 mesi" ||
        fields["Reason"] == "Elettrodomestici connessi"
      ) {
  ...
  const datiProdotto = (
    <div className={classnames("w-100")}>
      <div className={classnames(styles.paragraphh)}>
        ...
        <p>
          Le informazioni sul prodotto aiutano a rendere il servizio assistenza
        ...
        <div className={classnames(styles.supportReturn)}>
          ...
          <div className={classnames(styles.textArea)}>
            ...
            <div
              className={classnames(styles.inputTitle, styles.requiredInput)}
            >
              <label htmlFor="Segnalazione">
                INSERISCI QUI IL TESTO DELLA TUA SEGNALAZIONE
              </label>
            </div>
            {errors.Segnalazione ? (
              <span
          ...
          <div className={classnames(styles.consenso)}>
            ...
            <p className={classnames(styles.text)}>
              ...
              <a
                ...
                href="/pagine/informativa-sulla-privacy"
              >
            ...
            <div className="mb3">
              <Checkbox
                ...
                label="Acconsento al trattamento dei miei dati personali per permettere a Hotpoint Italia Srl di inviarmi newsletter/comunicazioni di marketing (in forma elettronica e non, anche tramite telefono, posta tradizionale, e-mail, SMS, MMS, notifiche push su siti di terze parti tra cui sulle piattaforme Facebook e Google) riguardanti prodotti e servizi di Hotpoint Italia Srl, anche da me acquistati o registrati, nonché di svolgere ricerche di mercato."
          ...
          <div className={classnames(styles.inviaButton)}>
            {isLoading ? (
              ...
              <div className={classnames(styles.messageText)}>
                <span>
                  Grazie per averci contattato! Ti abbiamo inviato una email con
            ...
            {isFormIncomplete ? (
              <div className={classnames(styles.inputError)}>
                Alcuni campi obbligatori non sono correttamente compilati
              </div>
            ) : null}
          </div>
        </div>
