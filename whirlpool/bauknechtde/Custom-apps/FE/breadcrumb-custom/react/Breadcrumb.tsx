      ...
      <div className={style.breadcrumbSliderContainer}>
        ...
        {  pathArray?.length > 0 ? 
            ...
            <>
              ...
              <img src="https://hotpointit.vteximg.com.br/arquivos/icons/arrowIconBread.svg" alt="caret icon" key={index}></img>
            </>
            :
            <>
              <span className={`${handles.link} ${spanBaseClasses} ${handles.lastItem}` } key={index}>
                {item.replace(/-/g, " ")}
              </span>
            </>
          })
