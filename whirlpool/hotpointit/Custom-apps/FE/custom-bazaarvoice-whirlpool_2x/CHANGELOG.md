...
- Added brief legal information [SCTASK0869530](https://whirlpool.service-now.com/nav_to.do?uri=sc_task.do?sys_id=368c58098724e15c5e0ebae6dabb35aa)

## [1.3.7] - 2022 - 12 - 20
- Changed the logic behind aggregateStructuredData and the rendering of those

## [1.3.6] - 2022-12-14
- Released stable version

## [1.3.6-beta.0] - 2022-12-12
- Added logic for Analytics GA4 event 'reviews_interaction'

## [Unreleased]

## [1.3.5] 2022-10-10
- changed the logic behind aggregate structured data and set bazaarvoice pixel to async false
