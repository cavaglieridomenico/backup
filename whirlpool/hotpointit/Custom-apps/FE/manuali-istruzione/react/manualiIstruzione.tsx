  ...
  return (
    <>
      <form
        ...
        action="https://docs.hotpoint.eu/default.cfm?startSearch=1&brand=WP&locale=IT&typeSearch=CODE"
        target="_blank"
        method="get">
          ...
          <div className={styles.inputContainer}>
            ...
            <input  className={styles.input} type="text" name="Campo_Ricerca" id="Campo_Ricerca" ref={ricercaValueContainer} />
          ...
          <div className={styles.inputContainer}>
            ...
            <input  className={styles.input} type="text" name="Campo_Ricerca_Code" id="Campo_Ricerca_Code" ref={ricercaCodeValueContainer} />
            <div className={classnames(styles.inputText)}>
              <span>
