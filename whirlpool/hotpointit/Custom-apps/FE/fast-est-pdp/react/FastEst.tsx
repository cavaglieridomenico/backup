...
const FastEst: StorefrontFunctionComponent<FastEstProps> = ({textButton,placeHolder, title}) => {
  ...
  return (
    ...
    >
      ...
      {delivery !== -1 ? (
          <div className={style.containerSuccess}><img src={deliveryIcon} alt="Spedizione" className={style.deliveryImage}/><div className={style.success}>Consegna stimata in {delivery} giorni!<br/><div className={style.subTitle}>Hotpoint considera solo i giorni feriali.</div></div></div>
        ) : (
          <></>
        )}
