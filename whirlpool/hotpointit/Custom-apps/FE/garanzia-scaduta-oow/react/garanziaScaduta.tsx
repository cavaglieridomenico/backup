...
interface GaranziaScadutaProps {
 ...
 useEffect(() => {
  ...
  return <div className={classnames(styles.formContainer, 'flex w-100 items-center justify-center')} id="booking-ref-app" data-brand="HP" data-country="IT" data-locale="it_IT" data-type="OOW"></div>
}
