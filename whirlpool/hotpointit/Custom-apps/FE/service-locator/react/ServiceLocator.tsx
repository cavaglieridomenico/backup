...
const ServiceLocator:StorefrontFunctionComponent<ServiceLocatorProps> = ({endpoint}) => {
  endpoint = 'https://store-locator.dev.wpsandwatch.com/static/bootstrap.js'
  useEffect(() => {
  ...
  return <div className="store-locator-app" id="store-locator-app" data-brand="HP" data-country="IT" data-locale="it_IT" data-type="service"></div>
}
