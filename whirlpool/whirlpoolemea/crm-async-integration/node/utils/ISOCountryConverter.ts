...
export function convertIocCode(iocCode: any): any {
  return icoCountries[iocCode];
};

export function convertIso2Code(iso2Code: any): any {
  return iso2Countries[iso2Code];
};

export function convertIso3Code(iso3Code: any): any {
