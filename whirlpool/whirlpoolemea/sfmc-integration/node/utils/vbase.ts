...
export async function saveObjInVbase(ctx: Context | StatusChangeContext, bucket: string, path: any, data: any, retry: number = 0): Promise<any> {
...
export async function getObjFromVbase(ctx: Context | StatusChangeContext, bucket: string, path: string, retry: number = 0): Promise<any> {
  return new Promise<any>((resolve, reject) => {
...
export async function deleteObjFromVbase(ctx: Context | StatusChangeContext, bucket: string, path: string, retry: number = 0): Promise<any> {
  return new Promise<any>((resolve, reject) => {
