...
import { GetProductDetails , GetUserToNotify, SendNotifications, UpdateSubscriptions } from './middlewares/SendBackNotifications'
import { CheckSubscription, Subscribe as SubscribeMiddleware } from './middlewares/Subscription'
...
export default new Service({
  ...
  routes: {
    subscribe: method({
      POST: [CheckSubscription, SubscribeMiddleware]
    }),
    backNotification: method({
      POST: [Authentication, GetProductDetails , GetUserToNotify, SendNotifications, UpdateSubscriptions]
    }),
