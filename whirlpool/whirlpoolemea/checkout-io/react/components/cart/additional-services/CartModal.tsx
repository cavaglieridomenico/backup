...
import style from "./styles/CartModal.css";
...
const messages = defineMessages({
  modalDescription: {
    ...
    id: "checkout-io.custom-additional-services.modalDescription",
  },
  modalCheckboxesTitle: {
    ...
    id: "checkout-io.custom-additional-services.modalCheckboxesTitle",
  },
  modalErrorMessage: {
    defaultMessage:
    ...
    id: "checkout-io.custom-additional-services.modalErrorMessage",
  },
  modalSaveButtonText: {
    defaultMessage: "SAVE",
    id: "checkout-io.custom-additional-services.modalSaveButtonText",
  },
});
...
const CartModal: StorefrontFunctionComponent<CartModalProps> = ({
  ...
  return (
    <>
      <div className={`${style.cartModalContainer}`} id="cartModalContainer">
        <button
          ...
          onClick={() => {
            closeModalHandler(),
              push({
                ...
                data: {
                  eventAction: "cartModalContainer",
                  eventLabel: "close",
                },
              });
          }}
        ...
        {checkboxIsPresent.map((item: any, idx: number) => (
          <div className={style.modalCheckboxContainer}>
            <input
              className={`mr3 ${style.modalCheckboxInput}`}
              type="checkbox"
              onChange={(e: any) => {
