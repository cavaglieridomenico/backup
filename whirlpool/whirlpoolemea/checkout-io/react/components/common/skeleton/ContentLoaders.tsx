...
export const CheckoutSkeleton = () => (
	<ContentLoader width="100%" speed={1} height="100%" viewBox="0 0 380 296">
		<rect x="0" y="-6" rx="3" ry="3" width="380" height="296" />
	</ContentLoader>
)
export const AddServicesSkeleton = () => (
	<ContentLoader width="100%" speed={1} height="100%" viewBox="0 0 380 150">
		<rect x="0" y="0" rx="5" ry="5" width="380" height="150" />
	</ContentLoader>
)
