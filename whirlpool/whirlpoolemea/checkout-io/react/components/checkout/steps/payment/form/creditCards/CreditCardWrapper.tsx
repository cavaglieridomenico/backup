...
const CreditCardWrapper: React.FC = () => {
	const intl = useIntl()
	...
	// )
	const [stage, setStage] = useState<PaymentStage>(
		isFreePurchase ? PaymentStage.FREE_PURCHASE : PaymentStage.CARD_FORM,
	)
				...
				<>
					<ListGroup>
						<GroupOption
							...
							payment="new"
						>
							<div className="flex items-center c-muted-1" data-testid="new">
