...
interface CheckboxesProps {
	...
	hideAcceptTermsCheckbox?: boolean
...
const Checkboxes: StorefrontFunctionComponent<CheckboxesProps> = ({
	...
	acceptTermsDefaultValue = false,
	hideAcceptTermsCheckbox = false,
	privacyCheckboxText = "",
	...
	useEffect(() => {
		if (hideAcceptTermsCheckbox) {
			setAcceptTerms(acceptTermsDefaultValue)
			setCustomDataValues({
				...customDataValues,
				acceptTerms: acceptTermsDefaultValue,
			})
		}
	}, [])
				...
				<label htmlFor="">
					{!hideAcceptTermsCheckbox && (
						<Checkbox
							...
							checked={
								acceptTerms ||
								customDataValues?.acceptTerms == "true" ||
								acceptTermsDefaultValue
							}
							required={isAcceptTermsRequired}
						/>
					)}
				</label>
				...
				<div className={`${style.checkboxDiv} flex`}>
					{!hidePrivacyCheckbox && (
						<Checkbox
							...
							label={intl.formatMessage(messages.optinLabelCheckbox)}
						/>
					)}
					{newsletterCheckboxText &&
						newsletterCheckboxLink &&
