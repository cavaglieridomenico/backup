...
const DeliveryForm: React.FC = () => {
	...
	const handleSubmit: React.FormEventHandler<HTMLFormElement> = async event => {
		...
		console.log("logisticsPayload: ", logisticsPayload)
		console.log("selectedAddresses: ", shippingData.selectedAddresses[0])
	...
	useEffect(() => {
		...
		console.log("updateDeliveryResponse: ", updateDeliveryResponse)
