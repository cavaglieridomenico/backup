...
const FriendsAndExpired: FC = ({ }) => {
  const { activeFriends, expiredFriends, expiredEmail, setExpiredEmail, removeFriend, isSuccessfullyRemoved, reInviteFriend, isSuccessfullyAdded, closeExpiredModal, friendEmail, setFriendEmail, closeFriendModal, putUserResponse } = useSection()
  const intl = useIntl()
                ...
                <>
                  <div key={index} className={style.friendCard}>
                    ...
                    <span className={style.cardLabelEmail}>
                      {utils.printDots(friend.email, 27)}
                    </span>
