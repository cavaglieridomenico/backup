          ...
          {enrichedGroups.map((group, index) => (
            ...
            >
              <div className={handles.prodSpec__groupName}>
                <p
                  className={
                    group.name == "Structural features"
                      ? handles.prodSpec__structuralFeatures
                      : handles.prodSpec__name
                  }
                ...
                <ul className={handles.prodSpec__list}>
                  {group.specifications
                    ...
                    .map((specification: SpecificationWithType, i: number) => (
                      <li
                        key={"productSpecificationsWithRules" + i}
                        className={handles.prodSpec__element}
                      >
