...
const CSS_HANDLES = [
  ...
  "ContactUsCarousel__buttonAssistenzaContainer",
  "ContactUsCarousel__openModal",
];
      ...
      <Carousel {...carouselProps}>
        ...
        >
          <div className={handles.contactUsCarousel__cardContainer}>
            ...
            <a
              className={handles.ContactUsCarousel__openModal}
              onClick={() => {
        ...
        >
          <div className={handles.contactUsCarousel__cardContainer}>
            ...
            <div className={handles.contactUsCarousel__descContainer}>
              <span className={handles.contactUsCarousel__description}>
                {
                  "Od poniedziałku do piątku skontaktujemy się z Tobą w ciągu 24h"
                }
              </span>
            </div>
            <ButtonAssistenza
              src="/pomoc/formularz-kontaktowy"
              isBlank={false}
              isPrimary={false}
