  ...
  return (
    <>
      <style>
        {
          "\
        .indesitpl-custom-apps-0-x-bannerProductBuyOnline__wrapperHidden .indesitpl-custom-apps-0-x-bannerProductBuyOnline__containerCenter {\
          bottom: -104px;\
        }\
        .indesitpl-custom-apps-0-x-bannerProductBuyOnline__containerCenter {\
      ...
      <div
        className={
          isSticky
            ? handles.bannerProductBuyOnline__wrapperShowed
            : handles.bannerProductBuyOnline__wrapperHidden
        }
      >
        <div
          className={
