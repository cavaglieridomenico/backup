      ...
      <div id="double_animation_container">
        ...
        >
          ...
          <div className={handles.homepage_text_label_container_reverse}>
            ...
            >
              {/* {titleText} */}
              Oszczędzasz czas, <br></br>pieniądze i siły.
            </p>
            <p
            ...
            >
              {/* {subtitleText} */}
              Zawsze gotowe do użytku, <br></br>intuicyjne i łatwe w obsłudze,
              nasze <br></br>urządzenia dają Ci wszystko, <br></br>czego potrzebujesz.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={handles.homepage_text_label_container}>
            ...
            >
              {/* {titleText2} */}
              Proste w obsłudze, <br></br>solidnie zbudowane, <br></br>miłe dla oka.
            </p>
            <p
            ...
            >
              {/* {subtitleText2} */}
              Przyjazne w użytkowaniu, <br></br>zrobione z myślą o tym, by utrzymać <br></br>atmosferę spokoju w Twojej rodzinie.
            </p>
          </div>
        </div>
      </div>
