      ...
      >
        ...
        <div className={handles.homepage_text_label_container}>
          <p id={animated_title_text} className={handles.homepage_text_label}>
            {/* {titleText} */}
            Trwałe, godne <br></br>zaufania, pewne.
          </p>
          <p
          ...
          >
            {/* {subtitleText} */}
            Urządzenia AGD marki Indesit <br></br>są bezpieczne i pewne. Możesz <br></br>im zaufać nawet przy małych <br></br>dzieciach w domu.
          </p>
        </div>
      </div>
    </>
