          ...
          <div className={handles.cardTechSupportMobile__cardContainer}>
            ...
            <div className={handles.cardTechSupportMobile__descContainer}>
              <span className={handles.cardTechSupportMobile__description}>
                {
                  "Jeśli masz ważną przedłużoną umowę gwarancyjną, możesz skorzystać z naszego internetowego portalu rezerwacji."
                }
              </span>
            </div>
        ...
        >
          <div className={handles.cardTechSupportMobile__cardContainer}>
            ...
            <div className={handles.cardTechSupportMobile__descContainer}>
              <span className={handles.cardTechSupportMobile__description}>
                {
                  "Jeśli kupiłeś produkt mniej niż dwa lata temu, możesz umówić się na spotkanie za pośrednictwem naszego działu obsługi klienta."
                }
              </span>
            </div>
            <button className={handles.cardTechSupportMobile__buttonContainer}>
        ...
        >
          <div className={handles.cardTechSupportMobile__cardContainer}>
            ...
            <div className={handles.cardTechSupportMobile__descContainer}>
              <span className={handles.cardTechSupportMobile__description}>
                {
                  "Jeśli Twoja gwarancja wygasła, nie martw się! Możemy zapewnić rozwiązanie dostosowane do Twoich potrzeb. Odkryj najlepszą ofertę, kup i zarezerwuj wizytę online."
                }
              </span>
            </div>
            <button className={handles.cardTechSupportMobile__buttonContainer}>
