...
const MatchingTechnologies: StorefrontFunctionComponent<
  ProductSpecificationsWithRulesProps
                ...
                {group.specifications
                  ...
                  .map((specification: SpecificationWithType, i: number) => (
                    <>
                      ...
                      >
                        <div className={handles.prodSpec__containerLeftElement}>
                          <a
                          ...
                          >
                            ...
                            >
                              {findElByName(specification.name) ? (
                                <span className={handles.prodSpec__openArrow} />
                              ) : (
                                <span
                                ...
                                <div className={handles.prodSpecMT__content}>
                                  <span
                                    ...
                                    dangerouslySetInnerHTML={{
                                      __html: `${
                                        specification.values[0].split(
                                          "><"
                                        )[0] /* specification.values.join(
                                          `.`
                                        )*/
                                      }`,
                                    }}
