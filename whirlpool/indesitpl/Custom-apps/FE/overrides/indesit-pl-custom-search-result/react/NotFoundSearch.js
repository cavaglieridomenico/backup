          ...
          <FormattedMessage id="store/search.what-do-i-do">
            {text => (
              <p className={`${handles.searchNotFoundWhatDoIDo} c-muted-2`}>
                {/* {text} */}
                Przepraszamy, brak wyników wyszukiwania. Spróbuj jeszcze raz, zmieniając filtry.
              </p>
            )}
          </FormattedMessage>
          {/* <FormattedMessage id={`store/search.what-to-do.1`}>
            {text => (
              <p className={`${handles.searchNotFoundWhatToDoDots} c-muted-2`}>
                Sorry, we couldn’t find any matches. Try a new filter combination.
              </p>
            )}
          </FormattedMessage> */}
          {/* <ul
