...
const ServiceLocatorRegions:StorefrontFunctionComponent<ServiceLocatorRegionsProps> = () => {
  ...
  useEffect(() => {
    let regions:any ={}
    fetch(
      'https://api.d2c.service-locator.wpsandwatch.com/v1/geo/regions?brand=WP&country=IT&locale=it_IT&country_id=Italia',
      {
        headers: {
  ...
  return <>
  <Helmet>
    <title> Cerca un tecnico  | Whirlpool Italia</title>
  </Helmet>
