...
const ObsoleteProductBanner = ({
  ...
  return (
    <div onClick={() => console.log(jcode)}>
      {showObsoleteBannner &&
        <div className={handles.substituteBanner}>
          <img className={handles.iconObsoleteBanner} src={iconObsolete} />
          <div className={handles.textObsoleteBanner}>
         Spare part {obsoleteModel} has been replaced by {product}
         </div>
        </div>
      }
    </div>
