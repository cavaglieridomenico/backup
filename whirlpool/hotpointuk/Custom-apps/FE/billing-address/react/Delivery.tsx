...
const Delivery: StorefrontFunctionComponent<billingProps> = ({}) => {
	...
	// let delivery;
	// new Date(orderGroup.totalDeliveryParcels[0].deliveryWindow.endDateUtc?).getHours().toString() === '3' && new Date(orderGroup.totalDeliveryParcels[0].deliveryWindow.startDateUtc).getHours().toString() === '3' ? delivery = false : delivery = true;
