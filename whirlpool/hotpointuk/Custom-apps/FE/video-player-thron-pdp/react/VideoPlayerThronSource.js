...
import { replaceImageUrls } from './utils/abTest'
...
const ProductImagesWrapper = props => {
	...
	let initialImages = JSON.parse(JSON.stringify(product.items[0].images));
	const imagesABTest = replaceImageUrls(initialImages);
	...
	return (
		<>
			<div className={styles.OldGallery}>
				<ProductImages
					images={images}
					videos={videos}
			...
			{/* <div className={styles.ABTestGallery}>
				<ProductImages
					images={imagesABTest}
					videos={[]}
					hiddenImages={props.hiddenImages}
