...
const OnlineGaranzia: StorefrontFunctionComponent<OnlineGaranziaProps> = ({endpoint }) => {
  useEffect(() => {
  ...
  return <div className={classnames(styles.formContainer, 'flex w-100 items-center justify-center')}> <div id="booking-ref-app" data-brand="WP" data-country="IT" data-locale="it_IT" data-version="2020"></div></div>
}
