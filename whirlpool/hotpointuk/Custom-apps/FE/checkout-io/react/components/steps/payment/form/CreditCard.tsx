...
const CreditCard = forwardRef<CreditCardRef, Props>(function CreditCard(
	{ onCardFormCompleted, onChangePaymentMethod, onSetCardType, cardType },
	ref,
) {
	...
	return (
		<div className="relative w-100">
			...
			{iframeLoading && (
				<div className="absolute top-0 left-0 right-0 bottom-0 bg-checkout-70 z-1 flex items-center justify-center">
