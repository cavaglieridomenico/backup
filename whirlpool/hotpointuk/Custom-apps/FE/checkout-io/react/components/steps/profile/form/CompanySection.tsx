...
const CompanySection: React.FC<CompanySectionProps> = ({ }) => {
  ...
  return (
    <>
      ...
      >
        <Input
          label={`${intl.formatMessage(messages.socialReason)}${customDatasRequiredFields?.isInvoiceSocialReasonRequired ? '*' : ''
            }`}
          name="invoiceSocialReason"
          type="text"
          value={customDataValues.corporateDocument}
      ...
      >
        <Input
          label={`${intl.formatMessage(messages.invoiceVat)}${customDatasRequiredFields?.isInvoiceVatRequired ? '*' : ''
            }`}
          name="invoiceVat"
          type="text"
          value={
