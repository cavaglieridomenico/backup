...
import { PaymentContextProvider } from "./components/steps/payment/context/PaymentContext"

import {
  ProductSummarySkeleton,
  CheckoutSkeleton,
} from "./components/skeleton/ContentLoaders"
// <ProductSummarySkeleton />
...
const Checkout: React.FC<CheckoutContainer> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (isCheckoutPage) {
      //qua aggiungo controllo sui customDatya o lo faccio atterra
