...
export default class PaymentClient extends JanusClient {
  ...
  public async processOrderTransaction(params: any, redUrl: any, orderGroup: any, transactionId: any, logger: Logger, /*CheckoutOrderFormOwnershipCookie: string*/): Promise<IOResponse<any>> {
  ...
  public async processOrder(orderGroup: any, cookies: any, logger: Logger): Promise<IOResponse<any>> {
    ...
    let headers = {
      ...
      'Content-Type': 'application/json',
      'Accept': 'application/json',
      'Cookie': cookies// ? `${cookies}; CheckoutOrderFormOwnership=${CheckoutOrderFormOwnershipCookie}` : `CheckoutOrderFormOwnership=${CheckoutOrderFormOwnershipCookie}`

    }

    console.log("mutationCreatePaymentFromExistingCart - cookies: ", headers.Cookie)
  ...
  public async addPaymentData(orderFormId: String, body: any, CheckoutOrderFormOwnershipCookie: string): Promise<IOResponse<any>> {
  ...
  // private buildCookie(cookie: string) {
  //   return
  // }
