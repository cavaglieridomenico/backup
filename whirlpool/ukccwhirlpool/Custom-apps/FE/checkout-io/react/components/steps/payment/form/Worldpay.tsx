...
export class WorldpayPaymentApp extends Component {
  ...
  constructor(props) {
    super(props)
    console.log("PAYMENT-FORM - WorldpayPaymentApp - props: ", props);
    console.log("PAYMENT-FORM - WorldpayPaymentApp - this.props: ", this.props);
  ...
  resultCallbackFunction = (responseData: { order: { status: any, orderKey: string } | undefined }) => {
    ...
    console.log("PAYMENT-ORDER-PLACED - WorldpayPaymentApp - resultCallbackFunction - responseData: ", responseData);
