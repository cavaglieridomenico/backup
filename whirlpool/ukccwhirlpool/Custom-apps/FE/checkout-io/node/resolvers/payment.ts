...
export const paymentMutations = {
  ...
  mutationCreatePaymentFromExistingCart : async (
    ...
    try {
      ...
      // The returned cookies are added to the context, so that they are continuously forwarded
      // Without these cookies, guest users cannot access the thank-you page
      ctx.cookies.set(
