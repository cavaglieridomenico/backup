...
### ADDED vtex.render-runtime@8.132.7-hkignore.1

Added this specific version to delete the white space present inside the cart, for checkout io. We are waiting the PR approval [here](https://github.com/vtex-apps/render-runtime/pull/640) the link.
Once the request will be approved we will uninstall this hkignore version to install the latest one.
