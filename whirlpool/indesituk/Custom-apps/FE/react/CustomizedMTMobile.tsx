                            ...
                            {specification.name === "Fast&Clean" ? (
                              ...
                              >
                                <ReactPlayer
                                  ...
                                  playIcon={<span className={handles.customizedMT__videoStartIcon}></span>}
                                  light={"https://whirlpool-cdn.thron.com/delivery/public/thumbnail/whirlpool/16aafbd2-504f-4725-846d-ea2b6f34c1a5/sckne7/std/1920x937/vi-18e2d707-f1cb-4118-b3e9-90?v=5"}
                                  controls={true}
                                  config={{
                                    file: {
                                      attributes: {
                        ...
                        <div className={handles.customizedMTMobile__col}>
                            ...
                            {specification.name === "Full Load Fast cycles" ? (
                              ...
                              >
                                <ReactPlayer
                                  ...
                                  url={getVideoUrl(specification.name)}
                                  playIcon={<span className={handles.customizedMT__videoStartIcon}></span>}
                                  light={"https://whirlpool-cdn.thron.com/delivery/public/thumbnail/whirlpool/276fdc51-bdd6-4706-a9cb-6404735be847/sckne7/std/1920x937/vi-67f160c3-0430-4b60-9e76-f5?v=57"}    
                                  controls={true}
                                  config={{
                                    file: {
                                      attributes: {
                          ...
                          >
                            <>
                              ...
                              {!readMore && specification.values.toString().slice(0, 180)}
                            {readMore && specification.values}{!readMore && (specification.values.toString().length > 180) && "..."}
                            <a className={handles.customizedMTMobile__readMoreLink} onClick={() => { setReadMore(!readMore) }}>{(specification.values.toString().length > 180) && linkName}</a>
                              </div>
                            </>
                          </div>
                        </div>
                            ...
                            {specification.name === "Push&Go" ? (
                              ...
                              >
                                <ReactPlayer
                                  ...
                                  controls={true}
                                  playIcon={<span className={handles.customizedMT__videoStartIcon}></span>}
                                  light={"https://whirlpool-cdn.thron.com/delivery/public/thumbnail/whirlpool/b2c19686-49c0-4d3a-ac8a-d25daa6821b2/sckne7/std/1920x937/vi-8d2d6fde-e2f9-47a5-847c-c8?v=59"}    
                                  config={{
                                    file: {
                                      attributes: {
                                        disablepictureinpicture: "true",
