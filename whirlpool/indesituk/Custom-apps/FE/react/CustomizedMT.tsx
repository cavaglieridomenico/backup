                      ...
                      <div className={handles.customizedMT__containerDescr}>
                        ...
                        <>
                          ...
                          {!readMore && specification.values.toString().slice(0, 140)}
                            {readMore && specification.values}{!readMore && (specification.values.toString().length > 140) && "..."}
                            <a className={handles.customizedMT__readMoreLink} onClick={() => { setReadMore(!readMore) }}>{(specification.values.toString().length > 140) && linkName}</a>
                          </div>
                        </>
                      </div>
                    </div>
