...
export default function HelmetSharing() {
  ...
  return (
    <Helmet>
      ...
      <meta name="twitter:creator" content="@indesitUk" />
...
{
  /* <meta name="twitter:url" content="https://sorcioindesituno--indesitukqa.myvtex.com/built-in-microwave-oven-stainless-steel-colour-f159150/p" /> */
}
