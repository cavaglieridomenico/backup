        ...
        >
          ...
          <div className={handles.homepage_text_label_container_reverse}>
            <p id={animated_title_text} className={handles.homepage_text_label_reverse}>
              {/* {titleText} */}
              Your solution <br></br>to saving time,<br></br> money and effort.
            </p>
            <p
            ...
            >
              {/* {subtitleText} */}
              Always ready, <br></br>intuitive and easy to use,<br></br> our appliances give you exactly<br></br> what you need.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={handles.homepage_text_label_container}>
            <p id={animated_title_text2} className={handles.homepage_text_label}>
              {/* {titleText2} */}
              Simple to use,<br></br> solid build quality,<br></br> easy on the eye.
            </p>
            <p
            ...
            >
              {/* {subtitleText2} */}
              User-friendly design<br></br> made to keep up with peace<br></br> of family life.
            </p>
          </div>
        </div>
      </div>
