...
const fePdp = (productContext: any, dataLayer: any, pageType: any, contentGrouping: any ) => {
...
const contentGroupingSecond = () => {
  ...
  if (
    urlWithoutQueryStrings.includes("/cooking") ||
    (urlWithoutQueryStrings.endsWith("/p") && category == "cooking")
  ) {
    //I'm in cooking
    return "Cooking";
  } else if (
    urlWithoutQueryStrings.includes("/laundry/") ||
    (urlWithoutQueryStrings.endsWith("/p") && category == "laundry")
  ) {
    //I'm in laundry
    return "Laundry";
  } else if (
    urlWithoutQueryStrings.includes("/cooling") ||
    (urlWithoutQueryStrings.endsWith("/p") && category == "cooling")
  ) {
    //I'm in cooling
    return "Cooling";
  } else if (
    urlWithoutQueryStrings.includes("/dishwashing") ||
    (urlWithoutQueryStrings.endsWith("/p") && category == "dishwashing")
  ) {
    //I'm in dishwash
    return "Dishwashing";
