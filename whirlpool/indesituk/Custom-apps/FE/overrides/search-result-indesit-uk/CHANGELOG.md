...
# [0.13.4] - 2022 - XX - XX
- Added an anchor and a hover management state in FetchMoreButton.js
## [Unreleased]
...
- SEO-Friendly pagination on search-result custom app.

## [0.13.4] - 2022-12-06

### Added

- **FilterBar.js** in *react/components/FilterBar.js*, imported *useModalDispatch* from vtex.modal-layout in order to close the filter modal after applying a filter. The issue was that applying one or more filters the Modal won't close and for this a workaround has been implemented. 
  MoB ticket: [INC2298288](https://whirlpool.service-now.com/nav_to.do?uri=incident.do?sys_id=13f73ace47ef9958073e68aaf36d431b%26sysparm_view=RPTa6ccc9921bff3818cdf96397624bcba8)
