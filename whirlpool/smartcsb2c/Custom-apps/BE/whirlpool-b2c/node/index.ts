...
import { getProduct, createProduct, updateProduct } from './middlewares/product';
...
import { createCollection, getCollectionById, getCollectionProducts, searchCollection, updateCollection } from './middlewares/collections';
...
import { getCategoryTranslation, getProductTranslation, getToken, translateCategory, translateProduct, triggerToken } from "./middlewares/translation";
...
export default new Service({
    ...
    routes: {
        ...
        productByfamilyGroupAndCategory: method({
            GET: [productByfamilyGroupAndCategory]
        }),
        ...
        searchProductBySpecification: method({
            GET: [setEnv, searchProductBySpecification]
        }),
        autocomplete: method({
            GET: [setEnv, autocomplete]
        }),
        ...
        // BOM
        scrollBom: method({
            GET: [setEnv, scrollBom]
        }),
        searchBom: method({
            GET: [setEnv, searchBom]
        }),
        sparePartsBom: method({
            POST: [setEnv, sparePartsBom]
        }),

        // CHECKSPAREPART
        checkSparePart: method({
            GET: [setEnv, checkSparePart]
        }),
