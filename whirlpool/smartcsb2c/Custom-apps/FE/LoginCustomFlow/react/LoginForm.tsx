...
const LoginForm: StorefrontFunctionComponent<Props> = ({
  ...
  useEffect(() => {
    ...
    if (window.location.href.includes("whirlpool.ch") && __RUNTIME__.culture.locale == "de-CH") {
      setPrivacyLink("https://whirlpool.ch/de/datenschutzerklaerung.html");
      setAgreeText(`Ich stimme zu, personalisierte Werbemitteilungen in Bezug auf Whirlpool und andere Marken der Whirlpool Corporation zu erhalten. `)
    }
    if (window.location.href.includes("whirlpool.ch") && __RUNTIME__.culture.locale == "it-CH") {
      setPrivacyLink("https://whirlpool.ch/it/informativa-sulla-privacy.html");
      setAgreeText(`Accetto di ricevere comunicazioni di marketing personalizzate relative a Whirlpool e altri marchi Whirlpool Corporation. `)

    }
    if (window.location.href.includes("whirlpool.ch") && __RUNTIME__.culture.locale == "fr-CH") {
      setPrivacyLink("https://whirlpool.ch/fr/protection-des-donn%C3%A9es.html");
      setAgreeText(`J'accepte de recevoir des communications marketing personnalisées relatives à Whirlpool et aux autres marques de Whirlpool Corporation. `)

    }
    
    if (window.location.href.includes("indesit.ch") && __RUNTIME__.culture.locale == "de-CH") {
      setPrivacyLink("https://www.indesit.ch/de_CH/Pages/Datenschutzerklaerung");
      setAgreeText(`Ich stimme zu, personalisierte Werbemitteilungen in Bezug auf Indesit und andere Marken der Whirlpool Corporation zu erhalten. `)

    }
    if (window.location.href.includes("indesit.ch") && __RUNTIME__.culture.locale == "it-CH") {
      setPrivacyLink("https://www.indesit.ch/it_CH/Pages/Informativa-sulla-Privacy");
      setAgreeText(`Accetto di ricevere comunicazioni di marketing personalizzate relative a Indesit e altri marchi Whirlpool Corporation. `)

    }
    if (window.location.href.includes("indesit.ch") && __RUNTIME__.culture.locale == "fr-CH") {
      setPrivacyLink("https://www.indesit.ch/fr_CH/Pages/Declaration-de-Confidentialite");
      setAgreeText(`J'accepte de recevoir des communications marketing personnalisées relatives à Indesit et aux autres marques de Whirlpool Corporation. `)

    }
    
    if (window.location.href.includes("bauknecht.ch") && __RUNTIME__.culture.locale == "de-CH") {
      setPrivacyLink("https://www.bauknecht.ch/de_CH/Pages/Datenschutzerklaerung");
      setAgreeText(`Ich stimme zu, personalisierte Werbemitteilungen in Bezug auf Bauknecht und andere Marken der Whirlpool Corporation zu erhalten. `)

    }
    if (window.location.href.includes("bauknecht.ch") && __RUNTIME__.culture.locale == "it-CH") {
      setPrivacyLink("https://www.bauknecht.ch/it_CH/Pages/Informativa-sulla-privacy");
      setAgreeText(`Accetto di ricevere comunicazioni di marketing personalizzate relative a Bauknecht e altri marchi Whirlpool Corporation. `)

    }
    if (window.location.href.includes("bauknecht.ch") && __RUNTIME__.culture.locale == "fr-CH") {
      setPrivacyLink("https://www.bauknecht.ch/fr_CH/Pages/Politique-de-protection-des-donnees-a-caractere-personnel");
      setAgreeText(`J'accepte de recevoir des communications marketing personnalisées relatives à Bauknecht et aux autres marques de Whirlpool Corporation. `)
  ...
  const showForm = () => {
    let form = Array.from(document.getElementsByClassName('vtex-login-2-x-content--beginCreatePass') as HTMLCollectionOf<HTMLElement>)[0]
              ...
              <div>
                ...
                <div className={style.informativa}>
                  {<p className={style.privacy}>
                    {translateMessage(messages.privacyLabel)}
                    <span className={style.colorEdb112}>
                      <a className={style.link} href={privacyLink} target="_blank">
                        {translateMessage(messages.privacyCtaLabel)}
                      </a>

                    </span>
                    {translateMessage(messages.andLabel)}
                  </p>}
                  <Checkbox
                    checked={privacy}
                    id="privacy-check"
