...
export default class TickIcon extends React.Component<Props> {
  render() {
    return (
        <svg style={{width:"12px", height:"12px",paddingRight:"5px"}} className={this.props.className} xmlns="http://www.w3.org/2000/svg" version="1.1"viewBox="0 0 367.805 367.805">
            <g>
