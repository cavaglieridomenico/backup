...
const ProductAvailabilityWrapper: StorefrontFunctionComponent<Props> = ({ threshold, lowStockMessage, highStockMessage }) => {
  ...
  return <ProductAvailability { ...{ threshold, lowStockMessage, highStockMessage, availability }} />
  {/*<div className={styles.availabilityFits}><img id="fits-appliance-img" className={styles.availabilityFitsImg}src="/arquivos/inspect.png" crossorigin="anonymous" /><p id="fits-appliance">Check if this part fits your appliance </p></div>*/}
