...
// GET -> /v1/translation/category/:id/:language
...
export async function getCategoryTranslation(ctx: Context, next: () => Promise<any>) {
    try {
        ...
        // Context settings
        const locale: string = language.toString();
        ctx.vtex.locale = locale.toString();

        const tenant: TenantHeader = {locale: 'en-GB'};
...
// GET -> /v1/translation/product/:id/:language
...
// POST -> /v1/translation/category/:language
// Translate category
...
// POST -> /v1/translation/product/:language
// Translate product
