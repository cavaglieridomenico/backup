...
const RatingInline: FC = () => {
  ...
  const total = !loading && !error && data && data.productReviews.Includes.Products[0]
  ? data.productReviews.TotalResults: null

  return average !== null ? (
    <div className={styles.containerInline+" review__rating mw8 center ph5"}>
