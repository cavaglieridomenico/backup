...
const AggregateStructuredData = () => {
  ...
  //const lowPrice = productInfo?.selectedItem?.sellers[0]?.commertialOffer?.PriceWithoutDiscount
  //const highPrice = productInfo?.selectedItem?.sellers[0]?.commertialOffer?.ListPrice
