...
- **index.tsx** fixed _productsQuery_ graphql query [INC2401565](https://whirlpool.service-now.com/nav_to.do?uri=incident.do%3Fsys_id=0c8273ce87ef65505e0ebae6dabb359f%26sysparm_stack=incident_list.do%3Fsysparm_query=active=true)

## [0.0.14] - 2022-21-06
  - [RUN-1759](https://whirlpoolgtm.atlassian.net/browse/RUN-1759) - Add a specific sentence related to the delivery date
## [0.0.13] - 2022-09-08
  - Display energy label and link
