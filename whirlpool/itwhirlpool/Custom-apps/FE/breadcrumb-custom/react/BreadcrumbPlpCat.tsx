...
const BreadcrumbPlpCat: StorefrontFunctionComponent<BreadcrumbPlpCatProps> = ({
  ...
  const categoryToCheck = searchQuery?.variables?.selectedFacets[0]?.value === "accessori" ? searchQuery?.variables?.selectedFacets[0]?.value :  searchQuery?.variables?.selectedFacets[2]?.value 
  const category = searchQuery?.variables?.selectedFacets[0]?.value === "accessori" ? searchQuery?.variables?.selectedFacets[1]?.value.replace(/-/g," ") : searchQuery?.variables?.selectedFacets[2]?.value.replace(/-/g," ");
  const prePlp = searchQuery?.variables?.selectedFacets[0]?.value === "accessori" ? searchQuery?.variables?.selectedFacets[0]?.value  : searchQuery?.variables?.selectedFacets[1]?.value;
  const baseUrl = "https://" + __RUNTIME__.assetServerLinkedHost;
  const prePlpUrl = searchQuery?.variables?.selectedFacets[0]?.value === "accessori" ? "/" + searchQuery?.variables?.selectedFacets[0]?.value : "/" + searchQuery?.variables?.selectedFacets[0]?.value + "/" + searchQuery?.variables?.selectedFacets[1]?.value
