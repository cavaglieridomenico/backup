...
const contactReason = [
  ...
  { value: 'Informazioni sui prodotti', label: 'Informazioni sui prodotti' },
  { value: 'Informazioni Acquisto sullo shop on line effettuato su www.whirlpool.it', label: 'Informazioni Acquisto sullo shop on line effettuato su www.whirlpool.it' },
  { value: 'Richiesta assistenza tecnica su  prodotto da 0 a 24 mesi', label: 'Richiesta assistenza tecnica su  prodotto da 0 a 24 mesi' },
  { value: 'Richiesta assistenza tecnica su  prodotto coperto da piano di estensione di assistenza e oltre il 24 mese di vita', label: 'Richiesta assistenza tecnica su  prodotto coperto da piano di estensione di assistenza e oltre il 24 mese di vita' },
  { value: 'Richiesta assistenza tecnica su  prodotto fuori garanzia', label: 'Richiesta assistenza tecnica su  prodotto fuori garanzia' },
  { value: 'Spostare, modificare o cancellare un appuntamento', label: 'Spostare, modificare o cancellare un appuntamento' },
  { value: 'Spostare o cancellare un appuntamento', label: 'Spostare o cancellare un appuntamento' },
  { value: 'Aggiornare /cancellare dati personali (gestione privacy) / GDPR cancellazione account', label: 'Aggiornare /cancellare dati personali (gestione privacy) / GDPR cancellazione account' },
]
...
const ENG_REASON = [
  ...
  "Move, update or delete an appointment",
    ...
    if (handleValidation()) {
      ...
      if(
        ...
        fields["Reason"] == "Attivazione piano estensione di assistenza"){
          formToSend["supportEmail"] = {"value": "gestioneconsumatore@whirlpool.com"}
      }else if (
        fields["Reason"] == "Informazioni per acquisto accessori e  prodotti per la pulizia"
      ){
        formToSend["supportEmail"] = {"value": "customercare@whirlpool.com"}
      }else if (
        fields["Reason"] == "Informazioni Acquisto sullo shop on line effettuato su www.whirlpool.it" ||
        ...
        fields["Reason"] == "Richiesta assistenza tecnica su  prodotto fuori garanzia"
      ){
        formToSend["supportEmail"] = {"value": "itservice199@whirlpool.com"}
      }else if (
        fields["Reason"] == "Richiesta assistenza tecnica su  prodotto da 0 a 24 mesi" ||
...
console.log(formToSend);
      ...
      const fetchUrl = "/crm-sync/create-contactus-user";
      const options = {
        method: "POST",
        headers: {
...
>
<label htmlFor="EstensioneDiGaranzia">ESTENSIONE DI ASSISTENZA
</label>
</div>
{errors.EstensioneDiGaranzia ? (
<span
