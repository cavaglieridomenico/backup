...
export function getPageType(url: string) {
  ...
  const isCampaignPage =
    urlWithoutQueryStrings.includes('promozioni') ||
    urlWithoutQueryStrings.includes('offerta') ||
    urlWithoutQueryStrings.includes('cashback-lavatrici-2022')
  const isSupport =
    urlWithoutQueryStrings.includes('supporto') ||
    urlWithoutQueryStrings.includes('faq')
  const isFooterOtherPages =
    url.includes('pagine') || url.includes('servizi-e-vantaggi')
  const isStory =
    urlWithoutQueryStrings.includes('innovazione') ||
    urlWithoutQueryStrings.includes('wcollection') ||
    urlWithoutQueryStrings.includes('asciugatrice-freshcare-whirlpool-italia')
  ...
  if (urlWithoutQueryStrings.endsWith('/p')) {
    ...
    //I'm in contact page
    if (urlWithoutQueryStrings.includes('ricambi-originali')) {
      return 'other'
    }
    return 'contact'
