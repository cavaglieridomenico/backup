          ...
          {isPrice ? (
            <div className={style.priceoos}>
              ...
              <div className={style.risparmiooscontainer}>
                <div className={style.listprice}> {listPrice.toFixed(2)} &nbsp;€ </div>
                
                <div> </div>
              </div>
              <div className={style.listandsellingprice}>
              
                  <div className={style.risparmioos}> Risparmi: &nbsp;{(listPrice-sellingPrice).toFixed(2)} &nbsp;€ </div>
                  <div className={style.risparmioosMobile}>-{Math.round(100-(sellingPrice*100)/listPrice)} &nbsp;% </div>
                <div className={style.sellingprice}>*{sellingPrice.toFixed(2)} &nbsp;€</div>
              </div>
            </div>
          ) : (
            <div></div>
