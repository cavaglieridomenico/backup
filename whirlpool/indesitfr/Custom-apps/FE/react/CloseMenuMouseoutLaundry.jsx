...
function FuncCloseMenuMouseoutLaundry(ref) {
  if (canUseDOM) {
    document.addEventListener("mouseout", (e) => {
      ...
      if (
        cursorPosition.classList.contains(
          "vtex-menu-2-x-styledLinkContent--label-header-item"
        ) &&
        cursorPosition.parentElement.nodeName == "SPAN"
      ) {
        if (
          !cursorPosition.classList.contains(
            "styledLinkContent--linkMenu--lastHover"
          ) &&
          document.querySelectorAll(".styledLinkContent--linkMenu--lastHover")
            .length < 1
        ) {
          cursorPosition.style.color = "#005c92";
          cursorPosition.classList.add(
            "styledLinkContent--linkMenu--lastHover"
          );
        } else if (
          !cursorPosition.classList.contains(
          ...
          cursorPosition.classList.add(
            "styledLinkContent--linkMenu--lastHover--active"
          );
          cursorPosition.classList.add(
            "styledLinkContent--linkMenu--lastHover"
          );
          cursorPosition.style.color = "#005c92";
          document
            .querySelectorAll(".styledLinkContent--linkMenu--lastHover")
          ...
          document
            .querySelector(".styledLinkContent--linkMenu--lastHover--active")
            .classList.remove("styledLinkContent--linkMenu--lastHover--active");
        }
      } else if (
        (cursorPosition.classList.contains(
          "vtex-menu-2-x-styledLinkContent--label-header-item"
        ) &&
          cursorPosition.parentElement.nodeName == "A") ||
        cursorPosition.classList.contains(
          "vtex-menu-2-x-menuItem--label-header-item"
        ) ||
        cursorPosition.classList.contains(
