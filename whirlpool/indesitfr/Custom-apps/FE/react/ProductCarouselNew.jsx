      ...
      products.forEach((prod, index) => {
        if (prod && prod.properties) {
          const imageEnergyClass = prod.properties.find(
            (prop) => prop.name === "ÉnergieLogo_image"
          );
          ...
          // let typeOfConstruction= prod?.properties.find((el) => el.name === "type de construction").values[0]
  ...
  const productClickAnalytics = (i) => {
    if (products) {
      ...
      const variant = products[i]
        ? products[i].properties.filter((el) => el.name === "Couleur")[0]
            .values[0]
        : "";
        ...
        <style>
          {
            ...
            .glide__slide.slider .indesitfr-custom-apps-0-x-productCardCarousel__container .indesitfr-custom-apps-0-x-productCardCarousel__imageContainer .indesitfr-custom-apps-0-x-productCardCarousel__image{\
              width: 155px;\
            }\
            ...
            .glide__slide.slider.glide__slide--active .indesitfr-custom-apps-0-x-productCardCarousel__container .indesitfr-custom-apps-0-x-productCardCarousel__imageContainer .indesitfr-custom-apps-0-x-productCardCarousel__image{\
              width: 175px\
            }\
            @media screen and (max-width: 1024px){\
              .glide__slide.slider.glide__slide--active .indesitfr-custom-apps-0-x-productCardCarousel__container .indesitfr-custom-apps-0-x-productCardCarousel__imageContainer .indesitfr-custom-apps-0-x-productCardCarousel__image{\
            ...
            .glide__slide.slider.glide__slide--active .indesitfr-custom-apps-0-x-productCardCarousel__container .indesitfr-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitfr-custom-apps-0-x-productCardCarousel__textContainer .indesitfr-custom-apps-0-x-productCardCarousel__productNameLabel{\
            ...
            @media screen and (max-width: 1024px) {\
              ...
              .glide__slide.slider.glide__slide--active .indesitfr-custom-apps-0-x-productCardCarousel__container .indesitfr-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitfr-custom-apps-0-x-productCardCarousel__textContainer .indesitfr-custom-apps-0-x-productCardCarousel__labelImageContainer .indesitfr-custom-apps-0-x-productCardCarousel__productCodeLabel{\
                font-size: 12px !important;\
              }\
              .glide__slide.slider .indesitfr-custom-apps-0-x-productCardCarousel__container .indesitfr-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitfr-custom-apps-0-x-productCardCarousel__textContainer .indesitfr-custom-apps-0-x-productCardCarousel__labelImageContainer .indesitfr-custom-apps-0-x-productCardCarousel__productCodeLabel{\
                font-size: 12px !important;\
              }\
            }\
            ...
            .glide__slide.slider.glide__slide--active .indesitfr-custom-apps-0-x-productCardCarousel__container .indesitfr-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitfr-custom-apps-0-x-productCardCarousel__discoverMoreContainer{\
              margin-bottom: 4px;\
              margin-right: 4px;\
              }\
