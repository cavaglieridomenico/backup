  ...
  ({ hasTargetBlank, classes, filter = defaultFilter }) => {
    ...
    const nameChanger = (specification) => {
      switch (specification.name) {
        //French options
        case "label-energie-nouvelle":
          return "Nouvelles étiquettes énergétiques";
        case "fiche-produit":
          return "Fiche produits";
        case "product-fiche":
          return "Fiche produits";
        case "santé-sécurité-environnement":
          return "Information santé ed environnement";
        case "dans la fiche technique":
          return "Fiche d'information technique";
        case "guide-de-reference-quotidien":
          return "Guide d'utilisation quotidienne";
        case "indice de réparabilité":
          return "Indice de réparabilité";
        case "table de notation":
          return "Table de notation";
        case "utilisation-entretien":
          return "Utilisation et entretien";
        case "étiquette énergie":
