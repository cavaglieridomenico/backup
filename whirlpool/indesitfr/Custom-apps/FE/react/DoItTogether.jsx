            ...
            >
              ...
              <div>
                <h2 className={handles.doItTogether__textPushAndGo}>
                  {" "}
                  Une simple pression pour montrer le bon exemple.
                </h2>
              </div>
            </div>
          </div>
          <div className={handles.doItTogether__textAppliancesContainer}>
            ...
            >
              ...
              <div className={handles.doItTogether__buttonPrimaryContainer}>
                <ButtonPrimary
                  text={"Découvrez la gamme Innex"}
                  href="/produits/lavage/lave-linge"
        ...
        <div className={handles.doItTogether__maxiContainer}>
          <div
            ...
            onClick={() => {
              setOpenModalReview(!openModalReview);
              setvideoFile(
                "https://whirlpool-cdn.thron.com/delivery/public/video/whirlpool/84f378b7-5668-4d43-ab56-9a387a54f7e3/sckne7/WEBHD/vi-d46ec0d3-2edb-47b1-8dcc-18"
              );
            }}
            className={
              isBoyAndGirlVisible
          ...
          <div className={handles.doItTogether__pushAndGoRow}>
            <div className={handles.doItTogether__columnPushAndGo}>
              ...
              <div>
                ...
                >
                  {" "}
                  Découvrez une nouvelle génération de four.
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className={handles.doItTogether__maxiContainer}>
          <div
            ...
            onClick={() => {
              setOpenModalReview(!openModalReview);
              setvideoFile(
                "https://whirlpool-cdn.thron.com/delivery/public/video/whirlpool/d732084c-74c6-46e2-96f4-d7df3e4a9ee7/sckne7/WEBHD/vi-0152bb06-c299-4149-bfde-ae"
              );
            }}
            className={
              isPanVisible
          ...
          <div className={handles.doItTogether__pushAndGoRow}>
            <div className={handles.doItTogether__columnPushAndGo}>
              ...
              <div>
                ...
                >
                  {" "}
                  Une nouvelle atmosphère dans votre cuisine.
                </h2>
              </div>
            </div>
          </div>
          <div className={handles.doItTogether__textAppliancesContainer}>
            ...
            >
              ...
              <div className={handles.doItTogether__buttonPrimaryContainer}>
                <ButtonPrimary
                  text={"Découvrez les réfrigérateurs"}
                  href="/produits/froid/refrigerateurs"
                  hasTargetBlank={false}
                ></ButtonPrimary>
              </div>
            </div>
