  ...
  return (
    <>
      <style>
        {
          "\
        .indesitfr-custom-apps-0-x-bannerProductBuyOnline__wrapperHidden .indesitfr-custom-apps-0-x-bannerProductBuyOnline__containerCenter {\
          bottom: -104px;\
        }\
        .indesitfr-custom-apps-0-x-bannerProductBuyOnline__containerCenter {\
