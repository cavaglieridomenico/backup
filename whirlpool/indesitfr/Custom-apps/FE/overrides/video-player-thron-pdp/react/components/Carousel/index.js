...
const CSS_HANDLES = [
	...
	'swiperCaretNext',
	'swiperCaretPrev',
	'carouselGaleryThumbs__container',
]
...
class Carousel extends Component {
	...
	analyticsCallback() {
		...
		let analyticsJson = {
			event: 'contentIndex',
			contentIndex: this.props.slides.length,
		}
			...
			if (this.props.slides[activeIndex].type == 'video') {
				...
				if (vid !== undefined) {
					...
					vid.ontimeupdate = function () {
						...
						if (vid.currentTime > 49 && vid.currentTime < 51) {
							// let final = activeSlide.src.split("WEBHD/vi-");
							// const idVideo = final[1];
							// let dataLayer = window.dataLayer
							// if (!pushAfter50sec(dataLayer)) {
							// 	dataLayer.push({
							// 		event: 'thronVideo',
							// 		eventCategory: 'Product Experience',
							// 		eventLabel: 'Product Experience Video - ' + idVideo,
						...
						if (vid.currentTime > 74 && vid.currentTime < 76) {
							// let final = activeSlide.src.split("WEBHD/vi-");
							// const idVideo = final[1];
							// let dataLayer = window.dataLayer
							// if (!pushAfter75sec(dataLayer)) {
							// 	dataLayer.push({
							// 		event: 'thronVideo',
							// 		eventCategory: 'Product Experience',
							// 		eventLabel: 'Product Experience Video - ' + idVideo,
						...
						if (vid.currentTime > 89 && vid.currentTime < 91) {
							// let final = activeSlide.src.split("WEBHD/vi-");
							// const idVideo = final[1];
							// let dataLayer = window.dataLayer
							// if (!pushAfter90sec(dataLayer)) {
							// 	dataLayer.push({
							// 		event: 'thronVideo',
							// 		eventCategory: 'Product Experience',
							// 		eventLabel: 'Product Experience Video - ' + idVideo,
	...
	render() {
		...
		const thumbnailSwiper = (
			<div className={handles.carouselGaleryThumbs__container}>
				{' '}
				<ThumbnailSwiper
