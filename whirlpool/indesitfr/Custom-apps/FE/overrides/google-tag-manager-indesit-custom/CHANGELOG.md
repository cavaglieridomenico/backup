...
- Commented _new relic script_ due to the fact that a dedicated app (_whirlpoolemea.new-relic_) has been installed

## [0.0.18] - 2023-01-23
- Added NewRelic scripts 

## [0.0.17] - 2023-01-11

-Released stable version

## [0.0.17-beta-0] - 2023-01-09
...
- **legacyEvents.ts** changed contentGrouping fro "Error" to "Errors". [INC2236985](https://whirlpool.service-now.com/nav_to.do?uri=incident.do?sys_id=3bdd6e37978d9dd4a701d400f153afcc%26sysparm_view=RPTa6ccc9921bff3818cdf96397624bcba8)
