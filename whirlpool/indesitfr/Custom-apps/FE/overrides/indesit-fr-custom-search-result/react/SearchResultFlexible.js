...
const SearchResultFlexible = ({
  ...
  if(products.length <= 0) {
    const timeout = setTimeout(()=>{
      if(document && document.getElementsByClassName("vtex-flex-layout-0-x-flexRow--filter-order")){
        document.getElementsByClassName("vtex-flex-layout-0-x-flexRow--filter-order")[0].style.display = "none";
    ...
    const timeout = setTimeout(()=>{
      if(document && document.getElementsByClassName("vtex-flex-layout-0-x-flexRow--filter-order")){
        document.getElementsByClassName("vtex-flex-layout-0-x-flexRow--filter-order")[0].style.display = "block";
        clearInterval(timeout);
      }
    },300)
  }
