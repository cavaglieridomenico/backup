        ...
        <div className="pl7">
          <div
            ...
            className={classNames(
              `${searchResult.accordionFilterItem} ${searchResult.filterAccordionItemBox} t-body pr5 pv3 pointer b--muted-5`,
              {
      ...
      {open && (
        ...
        >
          {facets.map((facet) => {
            ...
            return (
              <div
                className={`${searchResult.filterAccordionItemBox} pr4 pt3 items-center flex b--muted-5`}
                key={name}
              >
                <Checkbox
                  className="mb0"
