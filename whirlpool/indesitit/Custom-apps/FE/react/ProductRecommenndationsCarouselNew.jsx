...
const ProductRecommenndationsCarouselNew = ({
  ...
  const CSS_HANDLES = ["ProductRecommenndationsCarouselNew__seoTextContainer", "ProductRecommenndationsCarouselNew__seoTextStyle"];
  ...
  switch (parseInt(productContext.product.categoryId)) {
    case 15:
      seoText = "Lasciati ispirare dalla nostra linea di lavatrici";
      break;
    case 16:
      seoText = "Lasciati ispirare dalla nostra linea di asciugatrici";
      break;
    case 17:
      seoText = "Lasciati ispirare dalla nostra linea di lavasciuga";
      break;
    case 18:
      seoText = "Lasciati ispirare dalla nostra linea di frigoriferi";
      break;
    case 19:
      seoText = "Lasciati ispirare dalla nostra linea di congelatori";
      break;
    case 20:
      seoText = "Lasciati ispirare dalla nostra linea di forni elettrici da incasso";
      break;
    case 21:
      seoText = "Lasciati ispirare dalla nostra linea di forni a microonde";
      break;
    case 22:
      seoText = "Lasciati ispirare dalla nostra linea di piani cottura";
      break;
    case 23:
      seoText = "Lasciati ispirare dalla nostra linea di cappe";
      break;
    case 24:
      seoText = "Lasciati ispirare dalla nostra linea di cucine";
      break;
    case 26:
      seoText = "Lasciati ispirare dalla nostra linea di lavastoviglie";
      break;
    default:
      seoText = "";
      break;
          ...
          if (prodLinkFixed) {
            const obj = {
              ...
              imageEnergyClass: imageEnergyClass
                ...
                : "",
              fCode: prod && prod.items && prod.items[0] ? prod.items[0].name : "",
              productImage: prod && prod.items && prod.items[0].images[0]
                ? prod.items[0].images[0].imageUrl
                : "",
              productImageAlt: prod && prod.items && prod.items[0] && prod.items[0].images[0]
              ...
              category: prod && prod.categories[0] && prod.categories[0].split("/")[2]
      ...
      {({ data, loading }) => {
        ...
        if (getDataFromQuery(productRecommendations).length > 0) {
          ...
          return (
            ...
            .card-container-carousel.glide__slide--active .indesitit-custom-apps-0-x-productCardCarousel__container{\
              height: 280px;\
              width: 604px !important;\
            }\
            .card-container-carousel.glide__slide--active .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__imageContainer{\
              height: 240px;\
              width: 240px;\
              border: 0;\
              padding: 18px;\
            }\
            .card-container-carousel.glide__slide--active .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer{\
              margin-left:44px;\
              height:100%;\
              display:flex;\
              flex-direction:column;\
            ...
            .card-container-carousel.glide__slide--active .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__textContainer{\
              width: 260px;\
              line-height: 18px !important;\
              margin: 34px 0 0 0!important;\
              color: #005c92;\
            }\
            .card-container-carousel.glide__slide--active .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__textContainer .indesitit-custom-apps-0-x-productCardCarousel__textStyle{\
              font-family: 'Roboto';\
              font-style: normal;\
            ...
            .card-container-carousel.glide__slide--active .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreText{\
              font-size:14px;\
              white-space:nowrap;\
            }\
            .card-container-carousel.glide__slide--active .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreIcon{\
              width: 32px;\
              height: 32px;\
            }\
            .card-container-carousel.glide__slide--active{\
            ...
            .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__imageContainer{\
              height: 210px;\
              width: 210px;\
              border: 0;\
              padding: 18px;\
            }\
            .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer{\
              margin-left:40px;\
              height:100%;\
              display:flex;\
              flex-direction:column;\
            ...
            .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__textContainer{\
              width: 247px;\
              line-height: 16px;\
              margin: 30px 0 0 0!important;\
              color: #005c92;\
            }\
            .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__textContainer .indesitit-custom-apps-0-x-productCardCarousel__productNameLabel{\
            ...
            .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreContainer{\
              display:flex;\
              justify-content:flex-end;\
            }\
            .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreText{\
              font-size:12px;\
              white-space:nowrap;\
            }\
            .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreContainer .indesitit-custom-apps-0-x-productCardCarousel__discoverMoreIcon{\
              width: 28px;\
              height: 28px;\
            }\
            @media(max-width:1024px){\
              ...
              .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container .indesitit-custom-apps-0-x-productCardCarousel__textAndCtaContainer .indesitit-custom-apps-0-x-productCardCarousel__textContainer .indesitit-custom-apps-0-x-productCardCarousel__textStyle{\
                font-family: 'Roboto-Light';\
                font-style: normal;\
                font-size: 12px!important;\
                line-height: 16px;\
            ...
            "
              ...
              <div className={handles.ProductRecommenndationsCarouselNew__seoTextContainer}>
                <span className={handles.ProductRecommenndationsCarouselNew__seoTextStyle}>
                  {seoText}
                </span>
              </div>
...
function InnerCard({ i, prod, productClickAnalytics, eventAnaliticts }) {
  ...
  return (
      <div id={"carousel_" + i + "_" + prod.fCode} key={i} className="card-container-carousel your_cutom_classname">
        <ProductCardCarousel
          productImage={prod.productImage}
          energyClassImage={prod.imageEnergyClass}
          linkEnergyLabel={prod.energyLabelPdf}
