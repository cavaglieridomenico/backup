...
export default function StoreLocatorLandingPages() {
    ...
    return (
        <>
            <div id="testciaocomestai" className={isStoreVisible ? handles.landingPages__storeLocatorContainerStyle : handles.landingPages__storeLocatorContainerStyleHidden}>
