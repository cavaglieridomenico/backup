...
export default function HomepageDoubleAnimationCircleMask({
  ...
  function hardResetImages() {
    TweenMax.to("#" + home_circle_animation_mask, dur, { attr: { r: r_minValue } });
    TweenMax.to("#" + home_circle_animation_mask2, dur, { attr: { r: r_minValue } });
      ...
      <div id="double_animation_container">
        ...
        >
          ...
          <div className={handles.homepage_text_label_container_reverse}>
            <p id={animated_title_text} className={handles.homepage_text_label_reverse}>
              {/* {titleText} */}
              La tua soluzione <br></br> per risparmiare tempo,<br></br> denaro e fatica.
            </p>
            <p
            ...
            >
              {/* {subtitleText} */}
              Sempre pronti, intuitivi e facili da usare,<br></br> i nostri elettrodomestici ti danno<br></br> esattamente ciò di cui hai bisogno.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={handles.homepage_text_label_container}>
            <p id={animated_title_text2} className={handles.homepage_text_label}>
              {/* {titleText2} */}
              Semplice da usare,<br></br> solida qualità,<br></br> piacevole alla vista.
            </p>
            <p
            ...
            >
              {/* {subtitleText2} */}
              Design intuitivo realizzato<br></br>per stare al passo con i bisogni <br></br> della vita familiare.
            </p>
          </div>
        </div>
      </div>
