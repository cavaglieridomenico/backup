            ...
            <div className={handles.homeSlider__item}>
              ...
              <div className={handles.homeSlider__descriptionContainer}>
                ...
                <p className={handles.homeSlider__paragraph}>
                  ...
                  <b style={{ fontFamily: "Roboto" }}>facili da usare</b> per aiutare le famiglie <br />
                  moderne ad affrontare la vita di tutti i giorni.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={handles.homeSlider__item}>
              ...
              <div className={handles.homeSlider__descriptionContainer}>
                ...
                <p className={handles.homeSlider__paragraph}>
                  ...
                  puoi gestire le faccende domestiche <br />
                  con un solo gesto, in tutta tranquillità.
                </p>
              </div>
            </div>
          </div>
