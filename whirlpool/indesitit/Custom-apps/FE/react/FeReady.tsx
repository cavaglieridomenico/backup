...
const feRPlp = (searchContext: any, dataLayer: any, pageType: any, contentGrouping: any) => {
  var done = false;
...
const contentGroupingSecond = () => {
  ...
  let breadcrumb = document.querySelectorAll(
  ...
  if (
      urlWithoutQueryStrings.includes('/cucina') ||
      (urlWithoutQueryStrings.endsWith('/p') && category == 'cucina')
  ) {
      //I'm in cooking
      return 'Cooking'
  } else if (
      urlWithoutQueryStrings.includes('/lavare/') ||
      ...
      urlWithoutQueryStrings.includes('/conservare') ||
      (urlWithoutQueryStrings.endsWith('/p') && category == 'conservare')
  ) {
      //I'm in cooling
      return 'Cooling'
  } else if (
      urlWithoutQueryStrings.includes('/lavare-i-piatti') ||
      (urlWithoutQueryStrings.endsWith('/p') && category == 'lavare i piatti')
  ) {
      //I'm in dishwash
      return 'Dishwashing'
  ...
  useEffect(() => {
    ...
    switch (pageType) {
      ...
      case "pdp":
        ...
        break;
      default:
        fePages(productContextValue, searchQuery, dataLayer, pageTypeEvent, contentGrouping);
        break;
    }
