  ...
  const dataCard = [
    {
      ...
      description:
        "Se hai acquistato il prodotto da meno di due anni, puoi prenotare un appuntamento attraverso il nostro Servizio Consumatori.",
      ctaText: "Prenota ora",
      href: "/",
      target: "",
    },
    {
      title: "Contratto di estensione di assistenza",
      description:
        "Se hai un contratto di estensione di assistenza valido, puoi usare il nostro portale di prenotazione online Repair & Care.",
      ctaText: "Prenota ora",
      href: "/assistenza/easy-service",
      target: "",
    },
    {
      title: "Garanzia scaduta",
      description:
        "Se la tua garanzia è scaduta, non preoccuparti! Possiamo fornire una soluzione su misura per te. Scopri la migliore offerta, acquista e prenota online il tuo intervento.",
      ctaText: "Prenota ora",
      href: "/assistenza/fuori-garanzia",
      target: "",
    },
  ];
      ...
      <style>
        {
          '\
            ...
            .carousel:hover .slide .legend {\
                ...
                .selected .card-container-carousel .indesitit-custom-apps-0-x-productCardCarousel__container{\
