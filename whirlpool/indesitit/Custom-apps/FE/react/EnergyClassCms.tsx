...
export default function EnergyClassCms({
  ...
  const pathImage = resolvedPathImage.replace(/ /g, "-").split('?')[0] + "?format=PNG&fillcolor=rgba:255,255,255";
  ...
  return (
    ...
    >
      ...
      <span className={handles.buttonEnergyClass__labelCms}>Classe energetica</span>
    </a>
  );
}
