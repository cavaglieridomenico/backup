...
export default function IsImageOrVideo({
  isVideo,
  videoFileCms,
  imageFileCms,
  imageVideoFileCms,
  ...
  const CSS_HANDLES = [
    ...
    "isImageOrVideo__imageVideoContainerMaxi"
  ...
  return (
    <>
      {isVideo ? (
        <>
          <div className={handles.isImageOrVideo__imageVideoContainerMaxi}>
