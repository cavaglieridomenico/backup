...
export default function ButtonYoureko() {
  function getYoureko() {
    ...
    script.async = true;
    script.src =
      "https://static.youreko.com/js/partners/it/indesit/youreko.energy-review.indesit.all.min.js";
  ...
  function getYourekoCallback(category)
  {
    if(document.getElementById("button-youreko-callback-" + prodId) === null)
    {
      const script = document.createElement("script");
      ...
      script.text = "function Youreko_Callback_" + prodId + "(v) {dataLayer.push({ event: 'youreko_badge', eventCategory: 'Youreko Badge', eventAction: v, eventLabel: '" + prodId + " - " + prodName + "', energy_saving_value: v, item_id: '" + prodId + "', item_name: '" + prodName + "', item_category: '" + category + "', item_macrocategory: '" + prodMacrocat + "' });}";
  ...
  function getProdMacroCategory(id) {
    switch (id) {
      case "4":
      case "15":
      case "16":
