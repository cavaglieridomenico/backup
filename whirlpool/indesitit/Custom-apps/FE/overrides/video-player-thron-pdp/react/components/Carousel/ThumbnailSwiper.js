					...
					return (
						<SwiperSlide
							...
							onClick={()=> {
								...
								// 	productImageAsset: slide.type==="video"? "video":(slide.thumbUrl || thumbUrls[i]),
								// 	productImageName : productContexInfo.selectedItem.nameComplete,
								// 	productImageCode : productContexInfo.selectedItem.name,
								//  	productImageFile : slide.url 
								// })
