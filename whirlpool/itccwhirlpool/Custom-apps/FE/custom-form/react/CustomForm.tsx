    ...
    switch (field) {
      ...
      case "OrderNumber":
        if (fields["OrderNumber"].length !== 16) {
          errors["OrderNumber"] = (
            <FormattedMessage id="store/custom-form.sixteen-chars" />
          );
          setFieldValid(false);
        } else {
          errors["OrderNumber"] = "";
      ...
      >
        <div className={classnames(styles.supportReturn)}>
          ...
          <div className={classnames(styles.singleInput)}>
            ...
            >
              <label htmlFor="City">
                <FormattedMessage id="store/custom-form.residenza" />
              </label>
            </div>
            ...
            <div className={classnames(styles.singleInput)}>
              <div className={classnames(styles.inputTitle)}>
                <label htmlFor="DocumentTransportNumber">
                  <FormattedMessage id="store/custom-form.DocumentTransportNumber" />
                </label>
              </div>
            ...
            <div className={classnames(styles.singleInput)}>
              <div className={classnames(styles.inputTitle)}>
                <label htmlFor="RefundReason">
                  <FormattedMessage id="store/custom-form.RefundReason" />
                </label>
              </div>
            ...
            <div className={classnames(styles.singleInput)}>
              ...
              >
                <label htmlFor="returnReason">
                  <FormattedMessage id="store/custom-form.returnReason" />
                </label>
              </div>
              <Input
                className={classnames(styles.inputTitle)}
        ...
        <div>
          {isReturn ? (
            <div className={classnames(styles.fotoDanno)}>
              ...
              >
                <FormattedMessage id="store/custom-form.support-email" />
              </a>
            </div>
          ) : (
            ""
          ...
          <div className={classnames(styles.campiObbligatori)}>
            <FormattedMessage id="store/custom-form.requiredField" />
          </div>
        </div>
        {isLoading ? (
          ...
          <div className={classnames(styles.messageText)}>
            <span>
              <FormattedMessage id="store/custom-form.messageText" />
            </span>
            <a className={classnames(styles.formLink)} href="/">
              <FormattedMessage id="store/custom-form.goBackHome" />
            </a>
          </div>
        ) : (
