      ...
      >
        <div className="flex flex-grow-1 flex-column pb8 pb0-ns">
          <span className={styles.titleLeft}>
            <FormattedMessage
            id="store/bazaar-voice.original-post.title-left"
            defaultMessage="Beurteilungsüberblick" />
          </span>
        ...
        {secondaryRatingsAverage && secondaryRatingsAverage.length !== 0 && (
          <div className={`flex flex-grow-1 flex-column ${styles.rightContainer}`}>
            <span className={styles.titleRight}>
              <FormattedMessage 
              id= "store/bazaar-voice.original-post.title-right"
              defaultMessage= "Durchschnittliche Kundenbeurteilungen"
              />
            </span>
