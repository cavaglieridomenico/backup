...
export const ContextProvider: React.FC = ({ children }) => {
  ...
  let fetchUrl = '/_v/wrapper/api/friends'
  const isEpp = window.location.href.includes("bindingAddress=epp.whirlpoolgroup.it");
  isEpp ? fetchUrl = `${fetchUrl}?host=testepp123.whirlpoolgroup.it` : fetchUrl
