      ...
      <div className={attachmentWrapperClass}>
        <div className={attachmentHeaderClass}>
          ...
          <div className={attachmentToggleWrapperClass}>
            <div className={attachmentToggleLabelClass}>{toggleLabel?.props?.children === "Gratuito" && culture.locale !== "it-IT" ? <FormattedMessage id="store/product.free-additional-services" /> : toggleLabel}</div>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className={attachmentWrapperClass} aria-expanded={isOpen}>
      ...
      >
        ...
        <span className={attachmentTitleClass}>{titleLabel}</span>
        <div className={attachmentToggleWrapperClass}>
        <div className={attachmentToggleLabelClass}>{toggleLabel === "Gratuito" && culture.locale !== "it-IT" ? <FormattedMessage id="store/product.free-additional-services" /> : toggleLabel}</div>
          {hasContent && (
