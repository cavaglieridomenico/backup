          ...
          <div className={style.informativa}>
            <div>
              ...
              <div style={{ display: "flex" }}>
                <div style={{ margin: "0.2rem 0.5rem", fontSize: "0.625rem" }}>
                  <Checkbox
                    checked={privacy}
                    id="privacy-check"
                    // label=""
                ...
                >
                  ...
                  permettre à Whirlpool France S.A.S. de m'envoyer des bulletins
                  d'information/communications marketing (sous forme
                  électronique et non électronique, y compris par téléphone,
                  courrier traditionnel, e-mail, SMS, MMS, notifications push
                  sur des sites tiers, y compris sur les plateformes Facebook et
                  Google) concernant les produits et services de Whirlpool
