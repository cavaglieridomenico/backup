...
const Wrapper = withToast(function Wrapper(props: Props) {
  ...
  const handleShowPrice = () => {
    ...
    if (community !== '') {
      const showPrice = getSpecificationValue(`showPrice${community}`)
      const sellable = getSpecificationValue(`sellable${community}`)
      if (
