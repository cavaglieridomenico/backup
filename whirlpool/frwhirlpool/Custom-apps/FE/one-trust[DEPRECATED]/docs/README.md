...
The custom app implements one trust.
One trust offers companies a more powerful and flexible cookie consent solution.
Cookie Consent One Trust allows companies to discover cookies and trackers hidden on websites using unique consent approaches based on location to optimize consent.
