...
export interface AvailabilitySubscribeData extends EventData {
  event: "availabilitySubscribe";
  eventName: "vtex:availabilitySubscribe";
  text: string;
}
