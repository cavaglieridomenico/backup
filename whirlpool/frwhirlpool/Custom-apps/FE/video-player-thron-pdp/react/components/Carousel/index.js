...
import IconFullScreen from './icon_full_screen_small.png'
import {
	THUMBS_ORIENTATION,
...
// 			eventLabel: 'Product Experience Video - ' + idVideo,
// 			eventAction: 'View a Video - ' + sec + ' secs',
// 		})
// 	}
// }
...
class Carousel extends Component {
	...
	handleSlideChange = () => {
		this.setState(prevState => {
			...
			this.props.onSlideChange && this.props.onSlideChange(activeIndex)
			return { activeIndex, sliderChanged: true }
		})
	}
	...
	render() {
		...
		const reDoVideo = () => {
			let videos = this.retriveAllVideoId()
			this.integrateVideoThron(videos)
			this.state.gallerySwiper.slideTo(this.state.activeIndex)
		}
