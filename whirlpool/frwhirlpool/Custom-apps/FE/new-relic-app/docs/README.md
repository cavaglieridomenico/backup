...
The custom app takes care of implementing the new relic app.
New relic is a platform for monitoring data and solving problems with it.
Specifically, the New relic app is responsible for ensuring the security and privacy of data.
