...
export interface WPCreateP24PaymentRequest extends WPCreatePaymentRequest {
  paymentService: {
    $: {
      version: string,
      merchantCode: string
...
export interface P24Order extends Order {
  order:
  {
    $: {
      orderCode: string,
