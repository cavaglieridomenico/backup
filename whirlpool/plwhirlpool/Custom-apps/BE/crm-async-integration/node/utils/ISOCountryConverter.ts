...
export function convertIocCode(iocCode: String): Object{
  return icoCountries[iocCode];
};

export function convertIso2Code(iso2Code: String): Object{
  return iso2Countries[iso2Code];
};

export function convertIso3Code(iso3Code: String): Object{
