...
interface AnalyticsProps {
  ...
  pageTypeEvent: 'home' | 'search' | 'contact' | 'detail' | 'category' | 'cart' | 'checkout' | 'purchase' | 'other' | 'error' | 'story' | 'campaign'
}
...
const Analytics: StorefrontFunctionComponent<AnalyticsProps> = ({ pageTypeEvent="other"}) => {
