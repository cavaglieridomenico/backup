...
const ProblemiSoluzioni: StorefrontFunctionComponent<ProblemiSoluzioniProps> = ({endpoint }) => {
  useEffect(() => {
    endpoint = endpoint ? endpoint : "//wia.prod.wpsandwatch.com/static/bootstrap.js";
  ...
  return <div id="booking-ref-app" data-brand="WP" data-country="PL" data-locale="pl_PL" data-version="2020"> </div>
}
