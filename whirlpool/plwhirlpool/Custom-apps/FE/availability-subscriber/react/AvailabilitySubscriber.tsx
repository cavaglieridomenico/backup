      ...
      <form className={`${styles.form} mb4`} onSubmit={e => handleSubmit(e)}>
        <div >
          ...
          <Checkbox
            ...
            /><span> Chcę otrzymać na podany adres email powiadomienie gdy ten produkt będzie dostępny.

            (Twoje dane będą chronione z godnie z naszą <a href="/informacja-o-ochronie-prywatnosci" target="_blank" className={styles.policyLink}>Polityką Prywatności</a>)</span>
          </div>
