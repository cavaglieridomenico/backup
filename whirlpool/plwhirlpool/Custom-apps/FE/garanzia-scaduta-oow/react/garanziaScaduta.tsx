...
interface GaranziaScadutaProps {
 ...
 useEffect(() => {
  ...
  return <div className={classnames(styles.formContainer, 'flex w-100 items-center justify-center')} id="booking-ref-app" data-brand="WP" data-country="PL" data-locale="pl_PL" data-type="OOW"></div>
}
