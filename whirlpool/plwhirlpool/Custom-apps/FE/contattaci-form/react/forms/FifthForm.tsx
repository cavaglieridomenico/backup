...
const FifthForm: StorefrontFunctionComponent<FormProps> = (props) => {
        ...
        <>
          ...
          <div className={classnames(styles.groupInput)}>
            <div className={classnames(styles.singleInput, "w-100")}>
              ...
              />
              <div className={classnames(styles.inputTitle, styles.requiredInput)}>
                <label htmlFor="OrderOrInvoiceNumber">NUMER ZAMÓWIENIA LUB NUMER FAKTURY, KTÓRYCH DOTYCZYŁO ODSTĄPIENIE OD UMOWY</label>
              </div>
